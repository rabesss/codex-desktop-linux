...
CI checks this file on every push and pull request. The badges below are live GitHub workflow status links for `rabesss/codex-linux`.
...
[![Upstream Build App](https://github.com/rabesss/codex-linux/actions/workflows/upstream-build-app.yml/badge.svg?branch=main)](https://github.com/rabesss/codex-linux/actions/workflows/upstream-build-app.yml)
