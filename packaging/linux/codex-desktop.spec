...
%if __PACKAGE_WITH_UPDATER__
/usr/share/polkit-1/actions/com.github.codex-desktop-control.update.policy
%endif
...
%changelog
* Thu Jan 01 2026 Codex Desktop Control Maintainers <maintainers@codex-desktop-control>
- Initial RPM package
